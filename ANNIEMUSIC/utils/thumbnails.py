...
# Resize image with max width and height constraints
...
# Truncate long text into two lines
def truncate(text):
    words = text.split(" ")
    text1, text2 = "", ""
    for word in words:
...
async def get_thumb(videoid):
    ...
    # Add square thumbnail with no blur or glow
    ...
    # Add text for the title and details
    text_x_position = 565
    ...
    draw.text((text_x_position, 320), f"{channel}  |  {views[:23]}", fill=(255, 255, 255), font=arial)
    ...
    draw.text((text_x_position, 400), "00:00", fill=(255, 255, 255), font=arial)
    ...
    # Save and return the generated thumbnail
    try:
